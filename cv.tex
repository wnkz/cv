...
\begin{multicols}{3}
  ...
  \begin{center}
    \includegraphics[width=0.7\linewidth]{images/SAP.png}

    \includegraphics[width=0.45\linewidth]{images/SAA.png}
  \end{center}
  \vfill\null
  ...
  \begin{center}
    \includegraphics[width=0.7\linewidth]{images/BDS.png}
  \end{center}
  \vfill\null
\end{multicols}
